...
export function GlobalStateProvider({ children }: React.PropsWithChildren) {
	...
	useEffect(() => {
		...
		const handleLeaveRoom = (res: ServerLeaveRoomPayload) =>
			onLeaveRoom(res, { globalState, notifs })
		const handleChangeRoomData = (res: ChangeRoomDataPayload) =>
			onChangeRoomData(res, { globalState })
		const handleChangeAllUserData = (res: ChangeAllUserDataPayload) =>
			onChangeAllUserData(res, { globalState })
		const handleChangeUserData = (res: ChangeUserDataPayload) =>
			onChangeUserData(res, { globalState })
