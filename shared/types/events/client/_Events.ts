...
interface ClientEvents {
  ...
  'join-room': (value: ClientJoinRoomPayload, callback: ClientJoinRoomCallback) => Promise<void> | void
  /** Request to change username */
  'change-username': (value: ChangeUsernamePayload, callback: ChangeUsernameCallback) => Promise<void> | void
  /** Request to change color */
  'request-color': (value: RequestColorPayload, callback: RequestColorCallback) => Promise<void> | void
  /** Request to change state */
  'change-user-state': (value: ChangeUserStatePayload, callback: ChangeUserStateCallback) => Promise<void> | void
